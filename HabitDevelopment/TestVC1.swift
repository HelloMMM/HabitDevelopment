...
class TestVC1: SpotlightViewController {
    ...
    func next() {
            ...
            case 1:
                ...
                UIView.animate(withDuration: 0.5, animations: {
                    ...
                    self.txt.center = CGPoint(x: self.view.frame.width/2, y: (self.view3[0] as! CGPoint).y+60)
            ...
            case 2:
                ...
                UIView.animate(withDuration: 0.5, animations: {
                    ...
                    self.txt.center = CGPoint(x: self.view.frame.width/2, y: (self.view3[0] as! CGPoint).y+60)
                    self.txt.text = "填寫提醒天數"
                    UIView.animate(withDuration: 0.5) {
                        self.txt.alpha = 1
                    }
                })
                
                spotlightView.move(Spotlight.RoundedRect(center: CGPoint(x: screenSize.width/2, y: (view3[0] as! CGPoint).y), size: CGSize(width: (view1[1] as! CGSize).width, height: (view3[1] as! CGSize).height+10), cornerRadius: 5), moveType: .disappear)
            case 3:
...
extension TestVC1: SpotlightViewControllerDelegate {
