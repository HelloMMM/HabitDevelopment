...
func showToast(_ message: String) {
    ...
    toastLb.frame = CGRect(x: ((UIApplication.shared.keyWindow!.bounds.size.width)/2) - ((expectedSize.width + 20)/2), y: UIApplication.shared.keyWindow!.bounds.height - keyboardHeight - ((expectedSize.height + 20)*1.5), width: expectedSize.width + 20, height: expectedSize.height + 20)
